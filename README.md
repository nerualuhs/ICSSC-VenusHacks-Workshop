...
3. Click it and copy the SSH, navigate to your terminal
4. Make sure you have the folder/place where you want to store this repo open, then type ``git clone [paste your SSH code]``

⚠️ DO NOT PUSH YOUR CHANGES TO GITHUB WHEN YOU ARE DONE
...
Using Flex in CSS: https://css-tricks.com/the-shapes-of-css/ 

Absolutely goated website for indie developers!: https://delphi.tools/ 
